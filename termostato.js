...
class Termostato  extends EventEmitter {
	...
	encender() {
		...
		clearInterval(this.intervalId);  // Es el identificador de cada uno
		this.intervalId = setInterval(() => {
			this.emit('tic', this.habitacion.temperatura); // Evento tic para informar de la temperatura


			// Ademas comprueba la temperatura de la habitacion
